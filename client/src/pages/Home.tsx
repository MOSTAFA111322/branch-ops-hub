...
function OperationsView({ section, user, onNavigate }: { section: string; user?: { role?: string } | null; onNavigate: (section: string) => void }) {
  ...
  const updateRecordStatus = async (id: number, status: string, extra?: { score?: number; notes?: string; reportTitle?: string; findings?: string; recommendations?: string; approvalStatus?: "draft" | "submitted" | "approved"; priority?: "low" | "medium" | "high" | "urgent"; dueAt?: Date; title?: string; version?: string; expiresAt?: Date; documentStatus?: "valid" | "expiring" | "expired" | "missing"; documentType?: string; fileUrl?: string; rootCause?: string; ticketType?: "breakdown" | "preventive" | "warranty"; warrantyUntil?: Date; ownerId?: number | null; closureEvidenceUrl?: string }) => {
